...
import com.bitly.clone.dtos.ClickEventDTO;
...
import com.bitly.clone.repository.ClickEventRepository;
import com.bitly.clone.repository.UrlMappingRepository;
...
public class UrlMappingService {
    ...
    public UrlMapping getOriginalUrl(String shortUrl) {
        ...
        if (urlMapping != null) {
            recordAnalytics(urlMapping);
        }

        return urlMapping;
    }

    private void recordAnalytics(UrlMapping urlMapping) {
